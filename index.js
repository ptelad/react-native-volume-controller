...
export default class SliderVolumeController extends Component {
  ...
  render() {
    const dimension = this.props.sliderWidth;
    const viewWidth = dimension - 40;
    ...
    if (Platform.OS === "ios") {
      ...
      slider = (
        <ReactNativeVolumeControllerSlider
          ...
          style={[styles.slider, { width: sliderWidth - 40 }, style]}
        />
      );
    }
...
var ReactNativeVolumeControllerSlider = requireNativeComponent(
